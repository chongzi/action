...
| Name             | 属性   | 说明                                                        |
| ---------------- | ------ | ----------------------------------------------------------- |
| `QQREAD_CASH`    | 非必须 | 👉提现标准 可设置0 1 2 10 30 50 100 设置`0`关闭              |
| `QQREAD_BODY`    | 非必须 | 对应值可直接复制所获取的{ }所有内容(包括大括号)，多账号换行 |
| `QQREAD_TIMEURL` | 非必须 | 对应值直接复制填入，多账号换行                              |
| `QQREAD_TIMEHD`  | 非必须 | 对应值可直接复制所获取的{ }所有内容(包括大括号)，多账号换行 |
